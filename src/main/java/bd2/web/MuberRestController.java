...
public class MuberRestController {
	...
	public String example() {
		String pagina = "<!DOCTYPE html><html><head><title>Listado de los ws</title></head><body>"
				+"<a href='http://127.0.0.1:8080/MuberRESTful/rest/services/pasajeros'>listar todos los pasajeros</a><br>"
				+"<a href='http://127.0.0.1:8080/MuberRESTful/rest/services/conductores'>listar todos los conductores</a><br>"
				+"<a href='http://127.0.0.1:8080/MuberRESTful/rest/services/viajes/abiertos'>listar todos los viajes abiertos</a><br>"
				+"<a href='http://127.0.0.1:8080/MuberRESTful/rest/services/conductores/detalle/5'>listar detalle conductor id 5</a><br>"
				+"</body><html>";
		return pagina;
	}
	...
	public String conductorDetalle(@PathVariable(value="conductorId") int id) {
